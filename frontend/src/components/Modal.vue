      ...
      <form>
        <div class="inputs">
          ...
          <div class="form-inputs">
            ...
            <input type="text" placeholder="Nome do Pet" name="nome_pet" />
          </div>
        </div>
        <div class="inputs">
          <div class="form-inputs">
          ...
          <div class="form-inputs">
            ...
            <input type="text" placeholder="Serviços" name="servico" />
          </div>
        </div>
        <div class="inputs">
          <div class="form-inputs">
        ...
        <div class="modal-footer">
          ...
          <button v-on:click="toggleModal" type="submit" class="confirm">
            Confirmar
          </button>
        </div>
      </form>
